...
export function SignupForm({
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      const response = await axios.post(system_api.patient.signup, {
        first_name: firstName,
        last_name: lastName,
        gender,
  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card>
        <CardHeader>
          <CardTitle>{system_data.name} OPD Sign Up</CardTitle>
        ...
        <CardContent>
          <form onSubmit={handleSubmit}>
            ...
            <div className="mt-2 text-center text-sm">
              ...
              <Link href="/opd-login" className="underline underline-offset-4">
                Login
              </Link>
            </div>
          </form>
